...
public class OutletObject {
    ...
    public static OutletObject getInstance( UUID outletId, Context context)
    {
        ...
        String query = "select r.outletId , r.outletName , r.VisitDay, r.VisitDayId ,r.VisitOrder, r.CustomerId,r.CustomerName," +
                " r.partnerId, r.partnerName, r.address, con.PriceId , con.PriceName, r.IsRoute, oi.Category, r.CustomerClass  from route r" +
        ...
        for (int i=0;i<cursor.getCount(); i++) {
            ...
            ob.CustomerClass =  cursor.getString(cursor.getColumnIndex("CustomerClass"));
            cursor.moveToNext();
        }
        db.close();
        return ob;
