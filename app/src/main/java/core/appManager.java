...
//    }
    ...
    public ArrayList<priceType> getPriceType(Context context)
    {
        ...
        Cursor cursor = db.rawQuery("select distinct PriceId, PriceName from contracts " +
                " union" +
                " select '75a9d611-cd75-11e4-826a-240a64c9314e', '¬Ë‰ 14'" +
                " union" +
                " select '75a9d613-cd75-11e4-826a-240a64c9314e', '¬Ë‰ 7'" +
                " union" +
                " select 'b07c23b6-ed8d-11e4-9bea-3640b58dd6a2', '–€ÕŒ  Œœ“Œ¬€…'" +
                " union" +
                " select '11169df6-6987-11e8-82c8-3640b58dd6a2', 'ÍÛÔ˚ ‘'" +
                " union" +
                " select 'e3c64316-daa6-11e4-826d-240a64c9314e', ' ÛÔÌ˚È ÓÔÚ ‘¿ “'" +
                " union" +
                " select '849d3a4e-f26e-11e5-900e-3640b58dd6a2', 'VIP  ÎËÂÌÚ˚'", null);
        cursor.moveToFirst();
