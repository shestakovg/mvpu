 ...
 */
public class syncDebtParams extends AsyncTask<String, Integer, List<JSONObject>> {
    private Context context;
    private ProgressDialog pd;

    public syncDebtParams(Context context, ProgressDialog pd) {
    ...
    protected void onPostExecute(List<JSONObject> jsonObjects) {
        ...
        {
            syncSaveData.saveDebtParams(jsonObjects, context);
        }
