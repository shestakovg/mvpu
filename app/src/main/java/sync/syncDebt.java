 ...
 */
public class syncDebt extends AsyncTask<String, Integer, List<JSONObject>> {
    private Context context;
    private ProgressDialog pd;

    public syncDebt(Context context, ProgressDialog pd) {
    ...
    protected void onPostExecute(List<JSONObject> jsonObjects) {
        ...
        {
            syncSaveData.saveDebt(jsonObjects, context);
        }
