...
public class syncPriceChanges extends AsyncTask<String, Integer, List<JSONObject>> {
    private Context context;
    private ProgressDialog pd;

    public syncPriceChanges(Context context, ProgressDialog pd) {
    ...
    protected void onPostExecute(List<JSONObject> jsonObjects) {
        ...
        {
            syncSaveData.savePriceChanges(jsonObjects, context);
        }
