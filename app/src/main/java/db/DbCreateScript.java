...
public class DbCreateScript {
    ...
    private static String CREATE_ORDER_HEADER = "create table orderHeader(_id integer primary key autoincrement, orderUUID text, outletId text, " +
                " orderDate DATETIME DEFAULT CURRENT_TIMESTAMP,deliveryDate DATETIME DEFAULT CURRENT_TIMESTAMP, orderNumber integer DEFAULT 0, notes text, responseText text, _1CDocNumber1 text,  _1CDocNumber2 text, payType integer DEFAULT 0, autoLoad integer DEFAULT 0, orderType integer default 0," +
                " _send integer DEFAULT 0, deliveryDateInitialized integer DEFAULT 0, fromAutoOrder integer DEFAULT 0, " +
                " _1CDocId1 text, _1CDocId2 text, comment text, comment2 text)";
    ...
    private static String CREATE_SKU = "create table sku(SkuId text, SkuName text, SkuParentId text, QtyPack double, Article text, OnlyFact integer,CheckCountInBox integer, onlyMWH integer, Color text, OutStockColor text, MinOrderQty integer default 3, IsHoreca integer,  MaxOrderQty integer default 1000000, Description text)";
    ...
    private static String CREATE_PAY_REQUEST = "create table pay_requests (_id integer primary key autoincrement, requestDate  DATETIME DEFAULT CURRENT_TIMESTAMP, customerid text, _send integer DEFAULT 0)";
    private static String CREATE_PAY_REQUEST_IDX1 = "CREATE INDEX idx_pay_requests ON pay_requests (payDate,customerid)";
    ...
    public static  ArrayList<String> getCreateDataBaseScripts()
    {
        ...
        list.add(CREATE_PAY_REQUEST);
        list.add(CREATE_PAY_REQUEST_IDX1);
        return list;
    }
 ...
 //Drop tables
    ...
    private static String DROP_PAY_REQUESTS  = "drop table pay_requests";
