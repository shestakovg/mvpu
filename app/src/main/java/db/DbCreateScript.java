...
public class DbCreateScript {
    ...
    private static String CREATE_SKU = "create table sku(SkuId text, SkuName text, SkuParentId text, QtyPack double, Article text, OnlyFact integer,CheckCountInBox integer, onlyMWH integer, Color text, OutStockColor text, MinOrderQty integer default 3, IsHoreca integer)";
